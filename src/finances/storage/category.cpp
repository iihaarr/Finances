...
namespace finances::storage
{
   ...
   std::unique_ptr<entities::ICategory> CategoryStorage::GetById(utils::types::ID id_) const noexcept
   {
   ...
   utils::types::ID CategoryStorage::Create(const std::string & name_)  noexcept
   {
